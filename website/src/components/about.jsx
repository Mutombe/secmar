  ...
  const timeline = [
    {
      year: "2009",
      title: "Foundation",
      desc: "Sacmar Leaf Tobacco established",
      color: "from-green-600 to-green-700",
    },
    {
      year: "2015",
      title: "Partnership Growth",
      desc: "Expanded farmer network",
      color: "from-yellow-500 to-yellow-600",
    },
    {
      year: "2020",
      title: "Quality Excellence",
      desc: "ISO certification achieved",
      color: "from-green-700 to-green-800",
    },
    {
      year: "2024",
      title: "Global Expansion",
      desc: "International market leader",
    ...
    <div className="min-h-screen bg-white">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              >
                ...
                <h1 className="gellix-font text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-4 sm:mb-6 leading-none">
                  ...
                  <span className="gellix-font block text-yellow-400">
                    LEAF
                  </span>
                    ...
                    {stats.map((stat, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="gellix-font text-xl sm:text-2xl lg:text-3xl font-black text-white mb-1">
                            {stat.number}
                          </div>
                          <div className="gellix-font text-xs sm:text-sm text-white/80 font-medium">
                            {stat.label}
                          </div>
                        </motion.div>
                      );
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-yellow-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="gellix-font text-3xl sm:text-4xl lg:text-5xl font-black text-gray-900 mb-3 sm:mb-4">
              Our Journey
            </h2>
          ...
          <div className="block lg:hidden">
            <div className="space-y-6 sm:space-y-8">
              {timeline.map((item, index) => (
                ...
                >
                  <div
                    className={`bg-white p-6 sm:p-8 rounded-sm shadow-xl border-2 ${
                  ...
                  >
                    <div
                      className={`gellix-font inline-block px-3 py-1.5 sm:px-4 sm:py-2 rounded-sm bg-gradient-to-r ${item.color} text-white font-bold text-sm mb-4`}
                    >
                      {item.year}
                    </div>
                    <h3 className="gellix-font text-xl sm:text-2xl font-bold text-gray-900 mb-2">
                      {item.title}
                    </h3>
                    <p className="gellix-font text-gray-600 text-sm sm:text-base">
                      {item.desc}
                    </p>
                  </div>
                </motion.div>
            ...
            <div className="space-y-12">
              {timeline.map((item, index) => (
                ...
                >
                  ...
                  >
                    <div
                      className={`bg-white p-8 rounded-sm shadow-xl border-2 ${
                        activeTimeline === index
                          ? "border-yellow-400 shadow-2xl"
                          : "border-gray-200"
                      } transition-all duration-500`}
                    >
                      <div
                        className={`gellix-font inline-block px-4 py-2 rounded-sm bg-gradient-to-r ${item.color} text-white font-bold text-sm mb-4`}
                      >
                        {item.year}
                      </div>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="gellix-font text-base sm:text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto px-4">
              Our core values shape every partnership, every contract, and every
              leaf we produce
            </p>
          </motion.div>
            ...
            {values.map((value, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`inline-flex p-3 sm:p-4 rounded-sm sm:rounded-sm ${value.color} mb-4 sm:mb-6`}
                  >
                    <IconComponent className="w-6 h-6 sm:w-8 sm:h-8" />
                  </div>

                  <h3 className="gellix-font text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">
                    {value.title}
                  </h3>
                  <p className="gellix-font text-gray-600 leading-relaxed text-sm sm:text-base">
                    {value.desc}
                  </p>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-green-900 via-green-800 to-green-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-12 lg:mb-16"
          >
            <h2 className="gellix-font text-3xl sm:text-4xl lg:text-5xl font-black mb-3 sm:mb-4">
              How We Partner
            </h2>
            <div className="w-16 sm:w-20 lg:w-24 h-1.5 sm:h-2 bg-yellow-400 mx-auto rounded-sm mb-4 sm:mb-6" />
            <p className="gellix-font text-base sm:text-lg lg:text-xl text-green-100 max-w-3xl mx-auto px-4">
              Our comprehensive approach ensures mutual success and sustainable
              growth
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                desc: "Identify quality farmers and establish partnership goals",
                icon: SiPlanetscale,
              },
              {
                step: "02",
                title: "Contract Agreement",
                desc: "Define terms, quality standards, and competitive pricing",
                icon: FaFileContract,
              },
              {
                step: "03",
                title: "Technical Support",
                desc: "Provide ongoing assistance and financial backing",
                icon: GrTechnology,
              },
              {
                step: "04",
                title: "Quality Delivery",
                desc: "Ensure premium tobacco meets export standards",
                icon: GrSecure,
              },
            ].map((item, index) => {
              ...
              return (
                ...
                >
                  <div className="bg-white/10 backdrop-blur-sm p-6 sm:p-8 rounded-sm sm:rounded-sm border border-white/20 h-full hover:bg-white/15 transition-all duration-300">
                    ...
                    <h3 className="gellix-font text-lg sm:text-xl lg:text-2xl font-bold mb-3 sm:mb-4">
                      {item.title}
                    </h3>
                    <p className="gellix-font text-green-100 leading-relaxed text-sm sm:text-base">
                      {item.desc}
                    </p>
                  </div>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-yellow-400 via-yellow-500 to-orange-400">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h2 className="gellix-font text-3xl sm:text-4xl lg:text-5xl font-black text-green-900 mb-4 sm:mb-6">
              Ready to Partner with Us?
            </h2>
            <p className="gellix-font text-base sm:text-lg lg:text-xl text-green-800 mb-6 sm:mb-8 max-w-2xl mx-auto">
              Join our network of successful tobacco farmers and experience the
