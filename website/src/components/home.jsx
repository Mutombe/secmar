...
import { ChevronRight, ChevronLeft, Menu, X, Phone, Mail, MapPin, Leaf, Award, Users, Globe, CheckCircle, ArrowRight, Sun, Droplet, TrendingUp, Package, Shield, Sparkles, Briefcase, Building } from 'lucide-react';
...
const HomePage = () => {
  ...
  const directors = [
    ...
    { 
      ...
      description: "Overseeing quality control and export operations with 15+ years experience"
    },
    { 
      name: "Arief Yulianto", 
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-screen overflow-hidden bg-gray-900">
          ...
          {slides.map((_, index) => (
            <button
              ...
              className={`h-3 transition-all duration-500 ${
                index === currentSlide ? 'w-12 bg-yellow-400 shadow-lg shadow-yellow-400/30' : 'w-3 bg-white/40 hover:bg-white/60'
        ...
        <button
          ...
          className="absolute left-5 top-1/2 -translate-y-1/2 bg-black/20 backdrop-blur-md p-3 rounded-full hover:bg-black/30 transition-all duration-300 z-20 border border-white/20"
        >
          <ChevronLeft className="w-6 h-6 text-white" />
        </button>
        <button
          onClick={() => setCurrentSlide((prev) => (prev + 1) % slides.length)}
          className="absolute right-5 top-1/2 -translate-y-1/2 bg-black/20 backdrop-blur-md p-3 rounded-full hover:bg-black/30 transition-all duration-300 z-20 border border-white/20"
        >
      ...
      <section className="py-24 bg-amber-100 border-t-4 border-amber-500">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="gellix-font text-4xl md:text-5xl font-bold text-gray-900 mb-6">Our Products</h2>
            <p className="gellix-font text-xl text-gray-700 max-w-3xl mx-auto mb-8">
              Premium quality tobacco products crafted with expertise and precision for international markets
            </p>
            ...
            {[
              {
                name: "Tobacco Fines",
                image: "/fine.png",
                description: "Premium fine-grade tobacco for specialized applications"
              },
              {
                name: "Tobacco Stems",
                image: "/stem.png",
      ...
      <section className="py-24 bg-gradient-to-br from-slate-50 to-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="gellix-font text-4xl md:text-5xl font-bold text-gray-900 mb-6">Leadership Team</h2>
            <p className="gellix-font text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Meet the experienced professionals driving Sacmar Leaf's mission of excellence in tobacco production and export
            </p>
          ...
          >
            <div className="grid md:grid-cols-3 gap-6 text-center text-white">
              <div className="flex flex-col items-center">
                ...
                <h4 className="gellix-font font-bold text-lg mb-2">Quality Assurance</h4>
                <p className="gellix-font text-green-100 text-sm">Maintaining the highest standards in tobacco production</p>
              </div>
              <div className="flex flex-col items-center">
                <RiGlobalFill className="w-12 h-12 mb-4 opacity-90" />
                <h4 className="gellix-font font-bold text-lg mb-2">Global Reach</h4>
                <p className="gellix-font text-green-100 text-sm">Connecting farmers to international markets</p>
              </div>
              <div className="flex flex-col items-center">
                <FaPeopleCarry  className="w-12 h-12 mb-4 opacity-90" />
                <h4 className="gellix-font font-bold text-lg mb-2">Farmer Partnerships</h4>
                <p className="gellix-font text-green-100 text-sm">Building sustainable relationships with local growers</p>
              </div>
            </div>
          </motion.div>
        </div>
